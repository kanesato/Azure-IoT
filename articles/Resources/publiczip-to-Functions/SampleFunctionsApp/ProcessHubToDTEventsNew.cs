    ...
    public class ProcessHubToDTEvents
    {
        ...
        public async Task Run([EventGridTrigger]EventGridEvent eventGridEvent)
        {
            ...
            if (eventGridEvent != null && eventGridEvent.Data != null)
            {
                ...
                _logger.LogInformation($"Device:{deviceId} Humidity is:{humidity}");
                _logger.LogInformation($"Device:{deviceId} Pressure is:{pressure}");

                //Update twin using device temperature
                var updateTwinData = new JsonPatchDocument();
                updateTwinData.AppendReplace("/Temperature", temperature.Value<double>());
                updateTwinData.AppendReplace("/Humidity", temperature.Value<double>());
                updateTwinData.AppendReplace("/Pressure", temperature.Value<double>());
